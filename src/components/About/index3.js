            ...
            <Box pad="large" >
                <Grid
                    ...
                    <Box elevation="xlarge"round={{size: "xsmall"}} margin={{right: "10px"}} height="medium" background={{color:"light-6", opacity: "strong"}} gridArea="main" alignContent="center" justify="center" overflow="auto">
                        ...
                        <Box elevation="xlarge" round={{size: "xsmall"}} overflow="auto" gridArea="footer" responsive justify="evenly" gap="xsmall" wrap direction="row" background={{color:"light-6", opacity: "strong"}}  margin={{top: "30px", right: "10px"}} >
                        
                            
                        {data2.map((item) => (                     
                                <Button  item={item} key={item.id} onClick={onOpen}>                                                                                                   
                                ...
                                {/* <Button  onClick={onOpen}>                                                                                                   
                                            <Box  alignContent="center"  direction="row" height="xsmall" width="xsmall"  justify="center">           
                                                <Image fit="contain" src={require("./Carousel/IMG_5169.JPG").default}></Image>                                                                     
                                            </Box>                                    
                                </Button>
                                <Button  onClick={onOpen}>                                                                                                   
                                            <Box  alignContent="center"  direction="row" height="xsmall" width="xsmall"  justify="center">           
                                                <Image fit="contain" src={require("./Carousel/IMG_5813.JPG").default}></Image>                                                                     
                                            </Box>                                    
                                </Button>
                                <Button  onClick={onOpen}>                                                                                                   
                                            <Box  alignContent="center"  direction="row" height="xsmall" width="xsmall"  justify="center">           
                                                <Image fit="contain"src={require("./Carousel/IMG_6060.JPG").default}></Image>                                                                     
                                            </Box>                                    
                                </Button>
                                <Button  onClick={onOpen}>                                                                                                   
                                            <Box  alignContent="center"  direction="row" height="xsmall" width="xsmall"  justify="center">           
                                                <Image fit="contain"src={require("./Carousel/IMG_2032.JPG").default}></Image>                                                                     
                                            </Box>                                    
                                </Button>
                                <Button  onClick={onOpen}>                                                                                                   
                                            <Box  alignContent="center"  direction="row" height="xsmall" width="xsmall"  justify="center">           
                                                <Image fit="contain" src={require("./Carousel/IMG_2452.JPG").default}></Image>                                                                     
                                            </Box>                                    
                                </Button>
                                <Button  onClick={onOpen}>                                                                                                   
                                            <Box  alignContent="center"  direction="row" height="xsmall" width="xsmall"  justify="center">           
                                                <Image fit="contain" src={require("./Carousel/IMG_4185.JPG").default}></Image>                                                                     
                                            </Box>                                    
                                </Button> */}
                                ...
                                { open && ( 
                                    ...
                                    <Layer position="center" onClickOutside={onClose} onEsc={onClose}>
                                            ...
                                            <Box pad="medium" height="large" width="large">
                                                {data2.map((item) => (                                 
                                                    <Box  >
                                                        <Image fit="cover">{item.image}</Image>
                                                        <Text margin={{top:"small", bottom:"small"}}alignSelf="center"></Text>
