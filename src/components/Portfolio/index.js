...
const data = [
    ...
    },
    {
        ...
        summary: "A global five-day forecast app built using the openweathermap API.  Weather Dashboard uses localStorage to save your searched cities. A smooth UI was built using Bootstrap.",
    ...
    },
    {
        ...
        tech: "•Node •Inquirer •Markdown •JS",
    ...
    },    
    {
        ...
        summary: "This app allows the user to find sunrise and sunset times.  A clean, user-friendly UI was designed with Bulma.  This single-page app uses the Sunrise-Sunset, OpenCage, and Luxon APIs to bring the user tailored data.",
    ...
    },
    {
        ...
        summary: "Express-Notetaker can be used to write and save notes. This application uses an Express backend and saves and retrieves note data from a JSON file. ",
